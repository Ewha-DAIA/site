...
export default async function Domestic() {
  const publications = await loadData('publications/domestic.json');
  ...
  return `
    <section class="page-content">
      <div class="page-header">
        <h2 class="pub-header-title">Publications - Domestic</h2>
      </div>
      ...
      <div id="publications-container" class="publications-wrapper view-compact">
        ...
        `).join('') : '<p style="text-align:center; padding: 2rem; color: var(--text-secondary);">No domestic publications yet.</p>'}
      </div>
    </section>
  `;
}
